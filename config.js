...
module.exports = {
    ...
    AUDIO_DATA : process.env.AUDIO_DATA || "TECHO, TECHO,https://i.imgur.com/DyLAuEh.jpg",//audio metadata
    STICKER_DATA: process.env.STICKER_DATA || "TECHO, TECHO,https://i.imgur.com/DyLAuEh.jpg",//sticker metedata
    ...
    SUDO: process.env.SUDO || "94753420144,0",// sudo numbers to manage bot it will been add more by,
