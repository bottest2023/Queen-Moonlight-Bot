...
module.exports = {
    ...
    MENSION: {
        ...
        MENSION_TEXT : process.env.MENSION_TEXT || 'Queen - Moonlight - Bot,This Is My Full Command List, https://chat.whatsapp.com/FtNpa9CPTFxE7NXofQqdjW'
    },
    ...
    BOT_PRESENCE : process.env.BOT_PRESENCE || "typing",//bot presence
    ...
    GIT : process.env.GIT || "https://github.com/hightech-lab/Queen-Moonlight-Bot",//github url
